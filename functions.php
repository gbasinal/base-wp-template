...
function base_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'base' ),
		)
	);
...
function base_scripts() {
	...
	wp_enqueue_script( 'base-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
